...
(function (ng, undefined) {
  ...
  ng.module('smart-table', []).run(['$templateCache', function ($templateCache) {
    $templateCache.put('template/smart-table/pagination.html',
      ...
      '<li class="first"><a ng-click="selectPage(1)"><i class="iconfont icon-dingye"></i></a></li>' +
      '<li><a ng-click="selectPage(currentPage - 1)"><i class="iconfont icon-xialajiantou"></i></a></li>' +
      ...
      '<li ng-if="numPages - pages[pages.length - 1] > 1"><span class="ellipsis" style="border:0;">…</span></li>' +
      '<li ng-if="numPages != pages[pages.length - 1]"><a ng-click="selectPage(numPages)">{{numPages}}</a></li>' +
      '<li><a class="next" ng-click="selectPage(currentPage + 1)"><i class="iconfont icon-xialajiantou"></i></a></li>' +
      '<li class="last"><a ng-click="selectPage(numPages)"><i class="iconfont icon-weiye"></i></a></li>' +
      '</ul></nav>');
  }]);
